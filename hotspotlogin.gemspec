Gem::Specification.new do |s|
  ...
  s.files = ["doc/examples/hotspotlogin.conf.yaml", "README", "views/layout.erb", "views/hotspotlogin.erb", "views/_login_form.erb", "bin/hotspotlogin_ctl.rb", "bin/hotspotlogin.rb", "lib/hotspotlogin.rb", "lib/hotspotlogin/config.rb", "lib/hotspotlogin/app.rb", "lib/hotspotlogin/extensions/string.rb"]
